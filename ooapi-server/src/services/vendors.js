...
export const VENDORS = [
  ...
  // ---- 国产厂商直连（OpenAI 兼容，填 Key 即用）----
  {
    key: "mimo",
    name: "小米 MiMo",
    channelType: "mimo",
    desc: "小米 MiMo 开放平台（OpenAI 兼容）",
    loginModes: ["api"],
    fields: [],
    ...
    supportsBatch: false,
    supportsVision: true,
    hint: "在 platform.xiaomimimo.com 创建 API Key（sk-...）；思考模式下上游会忽略 temperature/top_p，属官方行为",
  },
  {
    key: "minimax",
    name: "MiniMax",
    channelType: "minimax",
    desc: "MiniMax 开放平台（国内 / 国际双端点）",
    loginModes: ["api"],
    fields: [],
    ...
    supportsBatch: false,
    supportsVision: true,
    hint: "国内账号用 api.minimax.cn、国际账号用 api.minimax.io（可在此处直接改 Base URL）；平台已强制开启 reasoning_split，思考内容不会混进正文",
  },
  {
    key: "stepfun",
    name: "阶跃星辰 StepFun",
    ...
    supportsBatch: false,
    supportsVision: true,
    hint: "在 platform.stepfun.com 创建 API Key；已下线的 step-1-*/step-2-mini/step-3 未登记",
  },
  {
    key: "ark",
    name: "火山方舟",
    channelType: "ark",
    desc: "字节火山方舟（Doubao Seed 系列）",
    loginModes: ["api"],
    fields: [],
    models: [
      "doubao-seed-2-1-pro",
    ...
    supportsBatch: false,
    supportsVision: true,
    hint: "用 API Key 鉴权时模型直接填 Model ID（如 doubao-seed-2-1-pro），不需要 ep- 接入点；方舟自动降级时平台按实际生效模型计费",
  },
  // ---- 三方兼容聚合（OpenAI 协议 + API Key，接入成本最低的一类）----
  {
    key: "opencode",
    name: "OpenCode Zen",
    channelType: "opencode",
    desc: "OpenCode 官方模型网关（OpenAI 兼容）",
    loginModes: ["api"],
    fields: [],
    models: ["gpt-5.6-luna", "claude-sonnet-4-5", "qwen3-coder", "grok-code", "kimi-k2"],
    baseUrl: "https://opencode.ai/zen/v1",
    supportsBatch: false,
    supportsVision: true,
    hint: "在 opencode.ai/zen 创建 API Key；也可把任意 OpenAI 兼容服务填到「自定义（通用兼容）」",
  },
  {
    key: "openrouter",
    name: "OpenRouter",
    ...
    loginModes: ["api"],
    fields: [],
    models: ["openai/gpt-5.5", "anthropic/claude-sonnet-4.5", "google/gemini-2.5-pro", "deepseek/deepseek-chat"],
    baseUrl: "https://openrouter.ai/api/v1",
    supportsBatch: false,
    supportsVision: true,
    hint: "OpenRouter Key（sk-or-...）；模型名保持 vendor/model 形式，可直接「拉取模型」同步目录",
  },
  {
    key: "siliconflow",
    name: "硅基流动",
    ...
    loginModes: ["api"],
    fields: [],
    models: ["deepseek-ai/DeepSeek-V3.2", "Qwen/Qwen3-235B-A22B", "zai-org/GLM-4.6", "moonshotai/Kimi-K2"],
    baseUrl: "https://api.siliconflow.cn/v1",
    supportsBatch: false,
    supportsVision: false,
    hint: "SiliconFlow Key；模型名保持组织/模型形式，可直接「拉取模型」同步目录",
  },
];
