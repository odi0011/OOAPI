...
export async function chat({
  ...
  if (search) {
    throw Object.assign(new Error("通义千问渠道暂不支持联网搜索，请去掉 search 参数"), { code: "CHANNEL_UNSUPPORTED" });
  }
  if (thinkingOverride === true && !resolved.thinking) {
    throw Object.assign(new Error("通义千问渠道暂不支持深度思考开关"), { code: "CHANNEL_UNSUPPORTED" });
  }
  if (signal?.aborted) {
